	...
	<div class="container">
		<div class="leftsidebar_box">
			...
			<dl class="channel">
				...
				<dd class="first_dd"><a href="${path }/admin/charts/studentExamCount.jsp" target="right" id="12" class="handle-view">&emsp;学生考勤信息&emsp;&emsp;&emsp;</a></dd>
			</dl>
		
			<dl class="app">
				<dt onClick="changeImage()">考勤管理<img src="${path }/images/left/select_xl01.png" /></dt>
				<dd class="first_dd"><a href="../examPapers" target="right" id="6" class="handle-view">&emsp;所有考勤&emsp;&emsp;&emsp;</a></dd>
			</dl>
		
		
			<dl class="syetem_management">
				<dt>考勤安排管理<img src="${path }/images/left/select_xl01.png" /></dt>
				<dd class="first_dd"><a href="../examPlans" target="right" id="9" class="handle-view">&emsp;待考勤信息&emsp;&emsp;&emsp;</a></dd>
			</dl>
		
			<dl class="source">
				<dt>以往考勤信息<img src="${path }/images/left/select_xl01.png" /></dt>
