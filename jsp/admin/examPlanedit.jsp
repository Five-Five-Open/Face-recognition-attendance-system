					...
					<form class="form-horizontal" role="form" id="examPlanAction" action="examPlan" method="post">
						<c:if test="${examPlan.examPlanId != null }">
							<div class="form-group">
								 <label for="examPlanId" class="col-sm-2 control-label">考勤编号</label>
								 <div class="col-sm-3">
						...
						<div class="form-group">
							 <label for="classId" class="col-sm-2 control-label">考勤班级</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							 <label for="examPaperId" class="col-sm-2 control-label">考勤信息</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							 <label for="beginTime" class="col-sm-2 control-label">开始考勤时间</label>
							<div class="col-sm-5">
